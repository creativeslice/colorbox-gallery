	...
	public function display_field ( $data = array(), $post = false, $echo = true ) {
		...
		switch( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'lazy-colorbox' ) . '" data-uploader_button_text="' . __( 'Use image' , 'lazy-colorbox' ) . '" class="image_upload_button button" value="'. __( 'Upload new image' , 'lazy-colorbox' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="'. __( 'Remove image' , 'lazy-colorbox' ) . '" />' . "\n";
