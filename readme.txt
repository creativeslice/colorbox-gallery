...
Installing "colorbox-gallery" can be done either by searching for "colorbox-gallery" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
